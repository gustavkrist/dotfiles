...
-- specs = vim.list_extend(specs, require("plugins.debugging"))
specs = vim.list_extend(specs, require("plugins.filetypes.chezmoi"))
-- specs = vim.list_extend(specs, require("plugins.filetypes.cpp"))
-- specs = vim.list_extend(specs, require("plugins.filetypes.fsharp"))
-- specs = vim.list_extend(specs, require("plugins.filetypes.haskell"))
-- specs = vim.list_extend(specs, require("plugins.filetypes.http"))
-- specs = vim.list_extend(specs, require("plugins.filetypes.java"))
...
specs = vim.list_extend(specs, require("plugins.filetypes.rocq"))
-- specs = vim.list_extend(specs, require("plugins.filetypes.rust"))
-- specs = vim.list_extend(specs, require("plugins.filetypes.scala"))
specs = vim.list_extend(specs, require("plugins.filetypes.typst"))
