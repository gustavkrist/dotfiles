...
c.TerminalInteractiveShell.highlighting_style_overrides = {
    Token.Prompt: "#A3BE8C",
    Token.PromptTime: "#EBCB8B",
    Token.PromptPath: "#8FBCBB",
    Token.PromptNum: "#8FBCBB",
    Token.PromptInsertMode: "#ECEFF4",
    Token.PromptNormalMode: "#88C0D0",
    Token.OutPrompt: "#BF616A",
    Token.OutPromptNum: "#D08770 bold",
    Token.PromptNormal: "#ECEFF4",
}
